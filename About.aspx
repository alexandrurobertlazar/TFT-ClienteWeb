    ...
    <div class="flex flex-row justify-center items-center w-screen h-screen">
        <div class="flex flex-col md:flex-row rounded-md container mx-auto border border-black shadow-sm py-4 md:justify-between items-center">
            ...
            <div class="w-full md:w-2/4 mt-4 md:mt-0">
                <p class="texto-about">Esta obra se ha realizado en el marco de una beca de colaboración para el <strong>Instituto Universitario de Análisis y Aplicaciones Textuales de la ULPGC</strong>.
                Además, compone el <strong>Trabajo de Fin de Grado</strong> de d. <em>Alexandru Robert Lazar</em>.<br>
