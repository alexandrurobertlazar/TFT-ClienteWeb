...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="flex flex-row w-full">
        ...
        <!--wrapper of modal-->
        <div class="absolute right-0 h-full bg-gray-300 flex flex-col justify-center text-center px-4 modal-closed" id="modal">
            ...
            <p class="text-3xl">Al insertar tu propio número, deja que la función de “Autocompletar” te ayude.<br />
                Para seleccionar una opción u otra con el teclado, utiliza las flechas, y, una vez tengas tu opción elegida, pulsa el tabulador.</p><br />
